...
function showConfirmHDialog(module, removeId, date_from, date_until) {
    var r = confirm("Ar tikrai norite pašalinti?");
    if (r === true) {
        window.location.replace("index.php?module=" + module + "&action=delete&id=" + removeId + "&from=" + date_from + "&until=" + date_until);
    }
}